...
//                       make new variable
                        ...
                        if (array_key_exists('images_edit', $data['data_1'])){
                            $response = $this->main->upload_file_custom('image', $data['data_1']['images_edit'][$key].$data_main['id_language'], 300, 300);
                        } else {
                            $response = $this->main->upload_file_custom('image', $data['data_1']['bank_name'][$key].$data_main['id_language'], 300, 300);
                        }
                        if (!$response['status']) {
                            echo json_encode(array(
                                'status' => 'error',
