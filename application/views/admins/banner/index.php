			...
			<?php foreach ($banner as $datas) : ?>
				<tr>
					...
					<td>
						...
						<a href="#"
						   data-action="<?php echo base_url() ?>proweb/home_banner/delete/<?php echo $datas->id ?>"
...
<form method="post" action="<?php echo base_url().'proweb/home_banner/createprocess' ;?>" enctype="multipart/form-data" class="form-send">
...
<form method="post" action="<?php echo base_url().'proweb/home_banner/update' ; ?>" enctype="multipart/form-data" class="form-send" >
