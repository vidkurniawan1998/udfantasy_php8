...
<!--					<td>--><?php //echo $datas->team_title ?><!--</td>-->
					<td><?php echo $datas->event_category_title ?></td>
					<td><?php echo $datas->use ?></td>
					<td>
						<a href="#"
						   class="btn btn-success btn-elevate btn-elevate-air btn-edit" data-tinymce="true">Edit</a>
						<a href="#"
						   data-action="<?php echo base_url() ?>proweb/event_content/delete/<?php echo $datas->id ?>"
...
<form method="post" action="<?php echo base_url() . 'proweb/event_content/createprocess'; ?>" enctype="multipart/form-data"
	  class="form-send">
...
<form method="post" action="<?php echo base_url() . 'proweb/event_content/update'; ?>" enctype="multipart/form-data"
	  class="form-send">
