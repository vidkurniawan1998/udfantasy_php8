		...
		<table class="table table-striped- table-bordered table-hover table-checkable datatable">
			...
			<?php foreach ($category as $datas) : ?>
				<tr>
                    ...
                    <td>
						<a href="<?php echo base_url().'proweb/products_sub_category/index/'.$datas->id ?>"
						   class="btn btn-primary btn-elevate btn-elevate-air btn-sub">Sub Category</a>
                    </td>
					<td>
						<a href="#"
						   class="btn btn-success btn-elevate btn-elevate-air btn-edit" data-tinymce="true">Edit</a>
						<a href="#"
						   data-action="<?php echo base_url() ?>proweb/products_category/delete/<?php echo $datas->id ?>"
...
<form method="post" action="<?php echo base_url() . 'proweb/products_category/createprocess'; ?>" enctype="multipart/form-data"
	  class="form-send">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="exampleSelect1">Title <?php echo $list->title ?></label>
                        <input type="text" class="form-control" placeholder="Title" name="title">
                    </div>
                    <div class="form-group">
                        <label for="exampleSelect1">English Title <?php echo $list->title_eng ?></label>
...
<form method="post" action="<?php echo base_url() . 'proweb/products_category/update'; ?>" enctype="multipart/form-data"
	  class="form-send">
