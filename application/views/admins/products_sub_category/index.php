	...
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			...
			<h3 class="kt-portlet__head-title">
				Management Sub Category <?php echo $parent->title; ?>
			</h3>
		</div>
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					<a href="<?php echo base_url(). 'proweb/products_category';?>" class="btn btn-warning btn-elevate btn-icon-sm">
...
<!--					<td><img src="--><?php //echo $this->main->image_preview_url($datas->thumbnail) ?><!--" width="--><?php //echo $this->main->image_size_preview() ?><!--" class="img-thumbnail"></td>-->
					...
					<td>
						...
						<a href="#"
						   data-action="<?php echo base_url() ?>proweb/products_sub_category/delete/<?php echo $datas->id ?>"
...
<form method="post" action="<?php echo base_url() . 'proweb/products_sub_category/createprocess'; ?>" enctype="multipart/form-data"
	  class="form-send">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="hidden" class="form-control" placeholder="Id Parent Category" name="id_parent_category" value="<?php echo $parent->id; ?>">
...
<form method="post" action="<?php echo base_url() . 'proweb/products_sub_category/update'; ?>" enctype="multipart/form-data"
	  class="form-send">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<label for="exampleSelect1">Title</label>
						<input type="hidden" class="form-control" placeholder="Id Parent Category" name="id_parent_category">
						<input type="text" class="form-control" placeholder="Title" name="title">
					</div>
					<div class="form-group">
						<label for="exampleSelect1">English Title</label>
