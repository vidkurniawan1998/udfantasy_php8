		...
		<table class="table table-striped- table-bordered table-hover table-checkable datatable">
			...
			<?php foreach ($region as $datas) : ?>
				<tr>
					...
					<td><?php echo $datas->order ?></td>
					<td>
						<a href="#"
						   class="btn btn-success btn-elevate btn-elevate-air btn-edit" data-tinymce="true">Edit</a>
						<a href="#"
						   data-action="<?php echo base_url() ?>proweb/wine_region/delete/<?php echo $datas->id ?>"
...
<form method="post" action="<?php echo base_url() . 'proweb/wine_region/createprocess'; ?>" enctype="multipart/form-data"
	  class="form-send">
...
<!--					</div>-->
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" placeholder="Order" name="order" min="1">
					</div>
					<div class="form-group">
...
<form method="post" action="<?php echo base_url() . 'proweb/wine_region/update'; ?>" enctype="multipart/form-data"
	  class="form-send">
