...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/uploaded/cerita'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT']. '/dosen_dicera_2' . $config['img_path']; // Physical path. [Usually works fine like this]
