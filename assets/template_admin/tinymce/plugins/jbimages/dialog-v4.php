...
<body>
	...
	<form class="form-inline" id="upl" name="upl" action="uploader/upload/english" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="jbImagesDialog.inProgress();">
